...
def gravarPlantaNoBanco(Planta):
	if(verificarPlantaNoBanco(Planta.nome)):
		try:
			Connection('Plantas').insert({"idPlanta":Planta.idPlanta,"Nome": Planta.nome,"Categoria": Planta.categoria ,"Foto": Planta.foto,"Descricao": Planta.descricao,"Tempo": Planta.tempo,"Nutrientes": Planta.nutrientes,"Calorias": Planta.calorias,"Passos": Planta.passos})
			return True
		except Exception:
			print(Exception)
			return False
